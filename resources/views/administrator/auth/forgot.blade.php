...
<head>
    ...
    <title>Login Dashboard Karang Taruna Wisanggeni</title>
    <meta name="viewport"
                        ...
                        <div class="modal-dialog w-100">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <div>
                                        <form class="___class_+?12___">
                                            <div class="form-row">
                                                <div class="col-md-12">
                                                    <div class="position-relative form-group">
                                                        <label for="exampleEmail" class="___class_+?16___">Email</label>
                                    ...
                                    <h6 class="mb-0">
                                        <a href="javascript:void(0);" class="text-primary">Sign in existing
                                            account</a>
                                    </h6>
                                </div>
...
<!-- Mirrored from demo.dashboardpack.com/architectui-html-pro/pages-login-boxed.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 12 Jul 2021 17:02:10 GMT -->
